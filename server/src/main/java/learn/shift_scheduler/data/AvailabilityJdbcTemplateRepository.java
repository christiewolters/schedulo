...
public class AvailabilityJdbcTemplateRepository implements AvailabilityRepository{
    ...
    public List<Availability> findAll() throws DataAccessException {
        final String sql = "select availability_id, start_time, end_time, employee_id from availability order by employee_id asc, start_time asc;";
    ...
    public List<Availability> findByEmployeeId(int id) throws DataAccessException{
        final String sql = "select availability_id, start_time, end_time, employee_id from availability where employee_id = ? order by start_time asc;";
